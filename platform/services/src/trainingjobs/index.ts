/**
 * Trainingjobs Services - Application Layer Export
 *
...
/**
 * Trainingjobs Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for trainingjobs domain.
 */
